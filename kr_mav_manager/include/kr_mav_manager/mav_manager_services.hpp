...
class MAVManagerServices
{
 public:
  ...
  {
    res->success = mav->goToTimed(req->goal[0], req->goal[1], req->goal[2], req->goal[3], 0.0f, 0.0f, false,
                                  req->duration, req->t_start);
  ...
  {
    RCLCPP_INFO(mav->get_logger(), "Starting Services...");
    ...
    takeoff_srv_ = mav->create_service<std_srvs::srv::Trigger>(
        "~/takeoff", std::bind(&MAVManagerServices::takeoff_cb, this, _1, _2));
    goHome_srv_ = mav->create_service<std_srvs::srv::Trigger>("~/goHome",
                                                              std::bind(&MAVManagerServices::goHome_cb, this, _1, _2));
    goTo_srv_ =
        mav->create_service<kr_mav_manager::srv::Vec4>("~/goTo", std::bind(&MAVManagerServices::goTo_cb, this, _1, _2));
    goToTimed_srv_ = mav->create_service<kr_mav_manager::srv::GoalTimed>(
        "~/goToTimed", std::bind(&MAVManagerServices::goToTimed_cb, this, _1, _2));
    goToRelative_srv_ = mav->create_service<kr_mav_manager::srv::Vec4>(
        "~/goToRelative", std::bind(&MAVManagerServices::goToRelative_cb, this, _1, _2));
    setDesVelInWorldFrame_srv_ = mav->create_service<kr_mav_manager::srv::Vec4>(
        "~/setDesVelInWorldFrame", std::bind(&MAVManagerServices::setDesVelInWorldFrame_cb, this, _1, _2));
    setDesVelInBodyFrame_srv_ = mav->create_service<kr_mav_manager::srv::Vec4>(
        "~/setDesVelInBodyFrame", std::bind(&MAVManagerServices::setDesVelInBodyFrame_cb, this, _1, _2));
    circle_srv_ = mav->create_service<kr_mav_manager::srv::Circle>(
        "~/circle", std::bind(&MAVManagerServices::circle_cb, this, _1, _2));
    lissajous_srv_ = mav->create_service<kr_mav_manager::srv::Lissajous>(
        "~/lissajous", std::bind(&MAVManagerServices::lissajous_cb, this, _1, _2));
    compound_lissajous_srv_ = mav->create_service<kr_mav_manager::srv::CompoundLissajous>(
        "~/compound_lissajous", std::bind(&MAVManagerServices::compound_lissajous_cb, this, _1, _2));
    hover_srv_ =
        mav->create_service<std_srvs::srv::Trigger>("~/hover", std::bind(&MAVManagerServices::hover_cb, this, _1, _2));
    ehover_srv_ = mav->create_service<std_srvs::srv::Trigger>("~/ehover",
                                                              std::bind(&MAVManagerServices::ehover_cb, this, _1, _2));
    land_srv_ =
        mav->create_service<std_srvs::srv::Trigger>("~/land", std::bind(&MAVManagerServices::land_cb, this, _1, _2));
    eland_srv_ =
