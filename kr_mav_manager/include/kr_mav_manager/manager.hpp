...
using CircleTracker = kr_tracker_msgs::action::CircleTracker;
using CircleTrackerGoalHandle = rclcpp_action::ClientGoalHandle<CircleTracker>;
using LissajousTracker = kr_tracker_msgs::action::LissajousTracker;
...
class MAVManager : public rclcpp::Node
{
 ...
 private:
  typedef rclcpp_action::Client<kr_tracker_msgs::action::LineTracker>::SharedPtr ClientType;
  ...
  void tracker_status_cb(kr_tracker_msgs::msg::TrackerStatus::ConstSharedPtr msg);
  void heartbeat();
  ...
  rclcpp::Subscription<kr_tracker_msgs::msg::TrackerStatus>::SharedPtr tracker_status_sub_;  // tracker_status_cb
