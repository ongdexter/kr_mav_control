...
class CrsfBridge : public ProtocolBridgeBase
{
 public:
 ...
 private:
  ...
  void handleReceivedCrsfMessage(const CrsfMsg &received_crsf_msg);
  ...
  std::unique_ptr<CrsfSerialPort> serial_port_;
  std::unique_ptr<CrsfMsg> last_msg_;
  // rclcpp Node
